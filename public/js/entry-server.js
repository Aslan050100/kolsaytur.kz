...
new Promise(function (resolve, reject) {
  ...
  _router__WEBPACK_IMPORTED_MODULE_1__["default"].onReady(function () {
    ...
    resolve(_App_vue__WEBPACK_IMPORTED_MODULE_0__["default"]);
  }, reject);
}).then(function (app) {
...
function PageComponent(name) {
  return {
    render: function render(h) {
      return h('h3', "Hello from the ".concat(name, " page"));
    }
  };
}
...
/* harmony default export */ __webpack_exports__["default"] = (new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  routes: [{
    path: '/',
    component: PageComponent('Landing'),
    name: 'landing'
  }, {
    path: '/detail:id',
    component: PageComponent('LandingForHotels'),
    name: 'detail'
  }]
}));
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\kolsaytur.kz\resources\js\entry-server.js */"./resources/js/entry-server.js");
