                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Comforts') }}</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('comfort.create') }}" class="btn btn-sm btn-primary">{{ __('Add Comfort') }}</a>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">                                                   
                                                        <form action="{{ route('comfort.destroy', $comfort->id) }}" method="post">
                                                            @csrf
                                                            <a class="dropdown-item" href="{{ route('comfort.edit', $comfort->id) }}">{{ __('Edit') }}</a>
