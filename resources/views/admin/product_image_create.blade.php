@extends('layouts.app', ['title' => __('Product_image Management')])

@section('content')
    @include('users.partials.header', ['title' => __('Добавить Объявление')])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Управление с фото продукта') }}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('product_image.store') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
