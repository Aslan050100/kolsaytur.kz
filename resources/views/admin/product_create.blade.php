                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('product') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('product.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="map" id="input-map" class="form-control form-control-alternative" placeholder="{{ __('Map') }}" value="{{ old('map') }}" required>
                                </div>
                                
                                <div class="form-group">
                                    <label class="form-control-label" for="input-password">{{ __('Product type') }}</label>
                                ...
                                <div class="form-group">
                                    <label class="form-control-label" for="input-password-confirmation">{{ __('City') }}</label>
