...
@section('content')
    @include('users.partials.header', ['title' => __('Add Comfort')])   
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Comfort Management') }}</h3>
                            </div>
                        ...
                        <form method="post" action="{{ route('comfort.store') }}" autocomplete="off"  enctype="multipart/form-data">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="icon" id="input-map" class="form-control form-control-alternative" placeholder="{{ __('Icon') }}" value="{{ old('icon') }}" required>
                                </div>
