...
Route::match(['get','post'],'/getProductByid/{id}','DetailsController@getProductByid')->middleware('cors');
Route::match(['get','post'],'/addOrder1','DetailsController@addOrder1')->middleware('cors');
